            ...
            <main className="pa4">
                <div className="measure center">
                    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                        ...
                        <div className="mt3">
                            <label className="white-70 db fw6 lh-copy f6" htmlFor="name">Name</label>
                    ...
                    <div className="">
                        <input onClick={() =>onRouteChange('home')} className="white-70 b ph3 pv2 input-reset ba b--black bg-transparent pointer f6 dib" type="submit" value="Register" />
                    </div>
                </div>
            </main>
        </article>
